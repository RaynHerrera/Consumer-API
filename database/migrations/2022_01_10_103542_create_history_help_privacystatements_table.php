...
class CreateHistoryHelpPrivacystatementsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('history_help_privacystatements', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('help_privacystatement_id');
            ...
            $table->string("weird_things", 2500)->comment("Enterprise Collects from you")->nullable();
            ...
            $table->date("elroi_internal_date")->nullable();
    ...
    {
        Schema::dropIfExists('history_help_privacystatements');
    }
}
